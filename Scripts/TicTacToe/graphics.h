...
/**
 * @brief Contains the images and their positions for the main official menuT at the begginig.
 */
typedef struct{
  SDL_Surface * splash; /**< Splash image. */
  SDL_Surface * menuBack; /**< menuT background image. */
  ...
  SDL_Rect menuBackPos; /**< menuT beckground position. */
...
/**
*@brief Contains images and positions of the menuT after play button is clicked.
*/
typedef struct {
...
int menuMotion(menuT mc, SDL_Surface * screen,
   SDL_Event event, soundFX sfx);
int menuClicks (menuT mc, SDL_Surface * screen,
  SDL_Event event , soundFX *sfx);
help initHelp();
