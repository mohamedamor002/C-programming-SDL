...
/**
 * @brief To initialize the official menuT of the game
 * @return menuT filled with all the data ready for print.
 */
menuT initOffMenu(){
  menuT m;
 ...
 * @param[in] menuT mc the struct to print.
  * @param[in] SDL_Surface* screen the screen to print.
 * @return nothing
 */
void showOffMenu(menuT mc, SDL_Surface * screen, soundFX sfx){
...
/**
 * @brief controls the menuT motion.
 * @param[in] menuT mc the struct to print.
  * @param[in] SDL_Surface* screen the screen to print.
 ...
 */
int menuMotion(menuT mc, SDL_Surface * screen, SDL_Event event, soundFX sfx){
  int y =0;
  static int played = 0;
...
/**
 * @brief controls the menuT clicks.
 * @param[in] menuT mc the struct to print.
  * @param[in] SDL_Surface* screen the screen to print.
 ...
 */
int menuClicks (menuT mc, SDL_Surface * screen, SDL_Event event, soundFX *sfx){
  int y = 0;
...
/**
 * @brief intialize the menuT of computer or friend.
 * @return a struct about filled with all elements needed to print the screen.
 */
...
/**
 * @brief Shows the menuT of computer of friend.
...
/**
 * @brief controls the mouse motion of the menuT of Play button.
 * @param[in] button bu commun buttons.
...
/**
 * @brief controls the clicks of menuT of the play button.
 * @param[in] SDL_Event event the action made by the user.
 * @param[in] button bu to print the buttons that are commun in all screens like back button.
 * @param[in] menuPlayGame mpg the struct that contains the elements of screen to test on.
 * @param[in] soundFX sfx a structure to get all the sounds.
...
/**
 * @brief Initializes the menuT of level packages.
