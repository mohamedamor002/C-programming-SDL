                ...
                if (click == 1) {
                    ...
                    if (p.pick == 'n') {
                      ...
                      if (p.pick == 'x') {
                        ...
                        do {
                          do {
                            SDL_WaitEvent( & event);
                            userInput = playerF(m, screen, pgs, p.pick, event, sfx);
                          } while (userInput == 0);
                  ...
                  if (click == 2) {
                    ...
                    do {
                      do {
                        SDL_WaitEvent( & event);
                        userInput = playerF(m, screen, pgs, 'x', event, sfx);
                      } while (userInput == 0);
                      checkwin(m, & winner, 'x', & won, screen, pgs);
                      if ((won != 1) && (checkfin(m) != 1) && ((userInput != -1) && (userInput != 3))) {
                        do {
                          SDL_WaitEvent( & event);
                          userInput = playerF(m, screen, pgs, 'o', event, sfx);
                        } while (userInput == 0);
                        checkwin(m, & winner, 'x', & won, screen, pgs);
                      }
                    } while (((checkfin(m) == 0) && (won == 0)) && ((userInput != -1) && (userInput != 3)));
                      ...
                      if ((lp.packChosen != 0) && (lp.packChosen != -1)) {
                        if (initPickScreen( & p) == 1) {
                          ...
                          if (p.pick == 'n') {
                            ...
                            backToLevels = 1; // to prevent going back to levels menuT each itiration of the loop.
                            if (p.pick == 'x') {
                              won = 0;
                              winner = 0;
                              played_once = 1;
