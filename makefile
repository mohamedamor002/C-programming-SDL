prog: main.o text.o button.o menu.o player.o game_background.o music.o minimap.o enemy.o game.o enigma.o tictac.o graphics.o core.o store.o save.o clothes.o
	gcc Compile/main.o Compile/text.o Compile/button.o Compile/menu.o Compile/player.o Compile/enigma.o Compile/game_background.o Compile/minimap.o Compile/enemy.o Compile/music.o Compile/tictac.o Compile/save.o Compile/graphics.o Compile/core.o Compile/store.o Compile/game.o Compile/clothes.o -o game -lSDL -g -lSDL_image -lSDL_mixer -lSDL_ttf
main.o:main.c
